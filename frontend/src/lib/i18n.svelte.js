...
const translations = {
    en: {
        ...
        settings: {
            ...
            themeLabel: 'Theme',
            apply: 'Apply',
            telemetry: 'Telemetry Receivers',
            telemetrySubtitle: 'Configure external services to receive telemetry data.',
            tempoEndpoint: 'Traces',
            tempoPlaceholder: 'http://tempo:4317',
            lokiEndpoint: 'Logs',
            lokiPlaceholder: 'http://loki:3100',
            prometheusEndpoint: 'Metrics',
            prometheusPlaceholder: 'http://prometheus:9090/api/v1/write',
            telemetryDisabled: 'Leave empty to disable. Requires restart to take effect.',
            telemetrySaved: 'Settings saved. Restart required.',
            test: 'Test',
            reachable: 'Reachable',
            telemetryTestFail: 'Unreachable',
        ...
        network: {
            ...
            subtitle: 'Configure network interfaces, DNS, and gateway.',
            refresh: 'Refresh',
            ...
            up: 'Up',
            down: 'Down',
            systemConfig: 'System Network',
            dns: 'DNS Servers',
            dnsPlaceholder: 'e.g. 8.8.8.8',
    ...
    de: {
        ...
        settings: {
            ...
            themeLabel: 'Theme',
            apply: 'Übernehmen',
            telemetry: 'Telemetry-Empfaenger',
            telemetrySubtitle: 'Externe Dienste fuer Telemetriedaten konfigurieren.',
            tempoEndpoint: 'Tempo (Traces)',
            tempoPlaceholder: 'http://tempo:4317',
            lokiEndpoint: 'Loki (Logs)',
            lokiPlaceholder: 'http://loki:3100',
            prometheusEndpoint: 'Prometheus (Metriken)',
            prometheusPlaceholder: 'http://prometheus:9090/api/v1/write',
            telemetryDisabled: 'Leer lassen zum Deaktivieren. Erfordert Neustart.',
            telemetrySaved: 'Einstellungen gespeichert. Neustart erforderlich.',
            test: 'Testen',
            reachable: 'Erreichbar',
            telemetryTestFail: 'Nicht erreichbar',
        ...
        network: {
            ...
            subtitle: 'Netzwerk-Interfaces, DNS und Gateway konfigurieren.',
            refresh: 'Neu laden',
            ...
            up: 'Aktiv',
            down: 'Inaktiv',
            systemConfig: 'System-Netzwerk',
            dns: 'DNS-Server',
            dnsPlaceholder: 'z.B. 8.8.8.8',
            dnsSearch: 'Such-Domains',
            gateway: 'Standard-Gateway',
            gatewayPlaceholder: 'z.B. 192.168.1.1',
            hostname: 'Hostname',
            ...
            useStatic: 'Statische IP verwenden',
            prefixLen: 'Präfix-Länge',
